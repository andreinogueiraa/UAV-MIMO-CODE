...
for l = 1:L
    ...
    for j = 1:L
        ...
        [distancesBSj_2D,whichpos] = min(abs( repmat(UEpositions(:,l),[1 size(BSpositionsWrapped,2)]) - repmat(BSpositionsWrapped(j,:),[K 1]) ),[],2);
        ...
        %distancia 3D entre UE e BS
        distancesBSj = sqrt(distancesBSj_2D.^2 + (alturaBS-alturaUE)^2);
